import { auth_default, buildURL, HttpError } from '../chunk-7AATMWZ5.js';
...
async function OfertaAcademicaCarreras(client, hostId) {
...
async function OfertaCentroCiclos(client, programId) {
...
async function OfertaAcademica(client, { cycleId, hostId, programId }) {
...
async function Horario(client, { programId, cycleId }) {
  const studentId = client.session.studentId;
