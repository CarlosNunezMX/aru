...
interface Constancia {
  ...
  planesEstudios: PlanesEstudios$1;
...
declare function OfertaAcademicaCentros(client: Client): Promise<OfferHost[]>;
declare function OfertaAcademicaCarreras(client: Client, hostId: string): Promise<OfferProgram[]>;
declare function OfertaCentroCiclos(client: Client, programId: string): Promise<OfferCycle[]>;
interface GetOfferParams {
    hostId: string;
    programId: string;
    cycleId: string;
}
declare function OfertaAcademica(client: Client, { cycleId, hostId, programId }: GetOfferParams): Promise<OfferCourse[]>;
...
declare function Horario(client: Client, { programId, cycleId }: ScheduleProps): Promise<Schedule.Item[]>;

declare function Student(client: Client): Promise<Student$1>;

export { Adeudos, Constancy, Credential, DeleteCourse, EmailAccounts, Horario, IsAgendaOpened, Kardex, OfertaAcademica, OfertaAcademicaCarreras, OfertaAcademicaCentros, OfertaCentroCiclos, PlanesEstudios, RegisterCourses, Report, Student };
