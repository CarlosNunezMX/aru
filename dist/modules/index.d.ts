import { Carreras as Carreras$1 } from '@interfaces/carreras/Carreras';
...
interface Oferta<
  ...
  Carrera extends Carreras$1.SelectCentroCarreras<Centro>,
> {
  idciclo: string;
  subjmateria: string;
  idsede: string;
...
declare function OfertaAcademicaCentros(client: Client): Promise<OfertaCentro[]>;
declare function OfertaAcademicaCarreras(client: Client, centro: string): Promise<OfertaCarreras<Centros>[]>;
declare function OfertaCentroCiclos(client: Client, carrera: string): Promise<OfertaCiclos[]>;
