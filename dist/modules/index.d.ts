import { C as Client } from '../client-cObyYvo_.js';
import 'jsonwebtoken';
...
interface OfertaParams {
    idCentro: string;
    carrera: Carreras$1.AnyCentro | string;
    ciclo: string;
}
...
declare function EmailAccounts(client: Client, idCentro: string): Promise<{
    microsoft: Email;
    google: Email;
}>;
...
declare const index_EmailAccounts: typeof EmailAccounts;
declare const index_Horario: typeof Horario;
declare const index_PlanesEstudios: typeof PlanesEstudios;
declare namespace index {
  export { index_Adeudos as Adeudos, index_Alumno as Alumno, index_EmailAccounts as EmailAccounts, index_Horario as Horario, index_PlanesEstudios as PlanesEstudios };
}
